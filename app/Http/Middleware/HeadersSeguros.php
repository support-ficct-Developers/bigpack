...
class HeadersSeguros
{
    ...
    public function handle($request, Closure $next)
    {
        ...
        $response->headers->set('Content-Security-Policy', "style-src 'self' 'unsafe-inline' cdnjs.cloudflare.com cdn.jsdelivr.net fonts.googleapis.com unicons.iconscout.com cdn.datatables.net app.embed.im; script-src 'self' unpkg.com pagead2.googlesyndication.com cdn.datatables.net code.jquery.com cdnjs.cloudflare.com"); // Esta cabecera si depende mucho de tu aplicación (Leer más después del código)
        return $response;
    }
