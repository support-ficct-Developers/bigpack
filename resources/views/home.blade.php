                ...
                <div class="home_container container grid">
                    <div class="home_content grid">
                        <div class="home_social">
                            ...
                            <a href="https://www.youtube.com/channel/UCz9Q7IBBcKw78nqP7V54WBA" target="_blank"
                        ...
                        <div class="home_data">
                            ...
                            <p class="home_description">Hola, Aquí encontraras links a repositorios de material de apoyo
                                para todas las materias de la Facultad de Ingeniera en Ciencias de la Computación.</p>
                        </div>
                    </div>
                </div>
            </section>
        ...
        <footer class="footer">
            <div class="footer_bg">
                ...
                <image class="footer__img" width="25%" height="25%" src="{{asset('imagenes/logowhite.png')}}"/>  --}}
                            <span class="footer_subtitle">#Estamos_para_ayudarte <br> #Cuenta_con_nosotros</span>
                        </div>
                        ...
                        <div class="footer_socials">
                            ...
                            <a href="https://chat.whatsapp.com/IIZZdKyTiW03F9IOdDpTKZ" target="_blank"
                                class="footer_social">
