        ...
        <div class="footer_bg">
            ...
            <div class="footer_container container grid">
                ...
                <ul class="footer_links">
                    ...
                    <li>
                        <a href="http://supportficct.com:81/postSemestres#semestres" class="footer_link">Semestres</a>
                    </li>
                    <li>
                        <a href="http://supportficct.com:81/developers" class="footer_link">Desarrolladores</a>
                    </li>
                </ul>
