<div class="preloader flex-column justify-content-center align-items-center">
    ...
    {{-- Preloader logo --}}
    {{--  <img src="{{ asset(config('adminlte.preloader.img.path', 'imagenes/intercentro.png')) }}"
         ...
         <img src="{{asset('imagenes/axiom.png')}}" class="{{ config('adminlte.preloader.img.effect', 'animation__shake') }}" alt="Preloader Logo intercentro" width="200px"
         height="200px">
