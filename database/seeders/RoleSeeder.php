...
class RoleSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Permission::create(['name'=>'admin.docentes.index'])->syncRoles([$role1, $role2 ]);
        Permission::create(['name'=>'admin.docentes.create'])->syncRoles([$role1, $role2 ]);
        Permission::create(['name'=>'admin.docentes.edit'])->syncRoles([$role1, $role2 ]);
